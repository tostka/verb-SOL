...
Describe 'Module Information' -Tags 'Command'{
    Context 'Manifest Testing' {
        ...
        It 'Valid Manifest GUID' {
            $Script:ManifestHash.Guid | Should -Be "1103d9d2-c746-4ef7-b063-3b4ca8dff805"
        }
        <#
        It 'No Format File' {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUYh3sJ7YJ9mm/LbER3tT7gWvd
# +eigggI4MIICNDCCAaGgAwIBAgIQWsnStFUuSIVNR8uhNSlE6TAJBgUrDgMCHQUA
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTCYlXT
# D/NpTRlBRVp5T+NTZezjMzANBgkqhkiG9w0BAQEFAASBgC3CwKmX4xoXkyDjdnF6
# z9a3KSDyEBDNfa5idBjexQlMRJkfjaX/MOXK0V5K9f62kSB7OPap3pnfeYiMVetM
# 5YY2eoWThoMO4g/AehRdfKezjw4Gceqc4QgBJhW15xesAP+3gaOb7QNeLFODm0Nd
# k7wA5UtZuTHKa5+8rAS75ncH
